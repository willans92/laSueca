...
class tienda {
    ...
    function contructor($id_tienda,$nombre,$cuenta,$contrasena,$estado,$registrado,$logo,
                        $fechaModifico,$registradoPor,$modificadoPor,$cliente_id) {
   ...
   function modificarFoto($id,$foto) {
    ...
    function insertar() {
        $consulta = "INSERT INTO lasueca.tienda (id_tienda,nombre,cuenta,contrasena,estado,registrado,logo,fechaModifico,registradoPor,modificadoPor,cliente_id,empresa_id) VALUES ('$this->id_tienda','$this->nombre','$this->cuenta',SHA2('$this->contrasena', 256),'$this->estado','$this->registrado','$this->logo','$this->fechaModifico','$this->registradoPor','$this->modificadoPor','$this->cliente_id','".$this->CON->empresa_id."');";
